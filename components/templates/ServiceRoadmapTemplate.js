...
export default function ServiceRoadmapTemplate({ answers }) {
  ...
  return (
    <div className="min-h-screen relative font-sans flex flex-col overflow-hidden bg-gray-50 dark:bg-gray-900 transition-colors duration-500">
