...
export function analyzeProjectContent(answers) {
  ...
  const textData = [
    ...
    answers.project1_title, answers.project1_desc,
    answers.project2_title, answers.project2_desc,
    answers.project3_title, answers.project3_desc,
    answers.design_project1_title,
    // ... 필요한 만큼 추가
  ].join(" ").toLowerCase();
